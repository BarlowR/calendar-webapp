...
class Calendar {
  ...
  render_to_display_context = () => {
    ...
    this.display_canvas_context.fillRect(
      0,
      0,
    ...
    this.scaling_context.fillStyle =
      this.calendar_data.visuals['background_color']
    this.scaling_context.fillRect(
      0,
      0,
      this.scaling_canvas.width,
      this.scaling_canvas.height
    )
    this.scaling_context.drawImage(
      this.staging_canvas,
      0,
      0,
  ...
  clamp_offset = () => {
    ...
    if (this.viewport_x < min_x) {
      ...
      this.viewport_x = max_x
    }
    if (this.viewport_y < min_y) {
      this.viewport_y = min_y
    } else if (this.viewport_y > max_y) {
      this.viewport_y = max_y
    }
  }
  ...
  onclick = e => {
    ...
    const [x, y] = mouse_to_scaled_translated_canvas(
      e.clientX,
      e.clientY,
      this.viewport_x,
      this.viewport_y,
  ...
  draw_month = (
    ...
    this.staging_context.fillText(
      month_name_mapping[month_num],
      x + current_day_of_week * day_size + pu(50),
      y + day_of_week_header + current_row * day_size + pu(50),
      day_size * 7,
      day_size * 6
    )
  }

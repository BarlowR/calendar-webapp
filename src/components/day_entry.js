class DayEntry {
  constructor (day_entry_sidebar_div, calendar_data, gdrive) {
    ...
    this.date_display =
      this.day_entry_sidebar_div.querySelector('#text-entry-date')
    this.date_form = this.day_entry_sidebar_div.querySelector('#day-form')
    this.text_entry =
      this.day_entry_sidebar_div.querySelector('#day-text-entry')
    ...
    // Set event listeners
    this.click_capture =
      this.day_entry_sidebar_div.querySelector('#day-click-capture')
  ...
  open_sidebar = (year, month, day) => {
    ...
    const checked_checkboxes = this.calendar_data.get_day_checkboxes(
      year,
      month,
      day
    )
  ...
  handle_submit = () => {
    ...
    this.calendar_data.set_day_checkboxes(
      this.current_year,
      this.current_month,
      this.current_day,
      checkbox_list
    ...
    this.calendar_data.set_day_text(
      this.current_year,
      this.current_month,
      this.current_day,
      text_entry_text
